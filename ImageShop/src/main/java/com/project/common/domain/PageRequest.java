...
public class PageRequest {
	...
	// 마이바티스 SQL 매퍼를 위한 메서드(해당되는 페이지수 위치 ex: 3페이지 요청하면 20부터 시작함)
	...
	// ?page=2&size=10&searchType=writer&keyword=kdj
	...
	// ?page=사용자가 원하는 페이지&size=10&searchType=writer&keyword=kdj
