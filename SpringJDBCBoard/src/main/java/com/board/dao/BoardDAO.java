...
public class BoardDAO {
	...
	public static String selctOne = "SELECT board_no, title, content, writer, reg_date FROM "
			+ "jdbcBoard WHERE board_no = ?";
	public static String delete ="delte from jdbcBoard where board_no = ?";
