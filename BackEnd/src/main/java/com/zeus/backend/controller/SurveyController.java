...
public class SurveyController {
	...
	@RequestMapping("/api /survey/view/{survey_idx}")
	public Map<String, Object> view(@PathVariable(name = "survey_idx") int survey_idx) throws
	Exception{
	log.info("survey/view/{survey_idx}="+survey_idx);
	return service.view(survey_idx);
	}

	@RequestMapping("/api /survey/insert")
	public void insert(@RequestParam Map<String, Object> map) throws Exception {
	System.out.println(map);
	service.insert(map);
	}

	@RequestMapping("/api /survey/summary/{survey_idx}")
